...
module.exports = {
    ...
    async execute({ inter }) {
        ...
        const pauseEmbed = new EmbedBuilder()
            .setAuthor({ name: success ? await Translate(`Current music <${queue.currentTrack.title}> paused <<:9744spotifypause:1269722763040653374>>`) : await Translate(`Something went wrong <${inter.member}>... try again ? <❌>`) })
            .setColor('#2f3136')
