   ...
   async execute({ inter }) {
        ...
        switch (inter.options._hoistedOptions.map(x => x.value).toString()) {
            case 'enable_loop_queue': {
                ...
                baseEmbed.setAuthor({ name: success ? errorMessage : await Translate(`**Repeat mode enabled **<a:3136simplemusicnote:1269705919684673536>\nthe whole queue will be repeated endlessly <🔁>`) })
            ...
            case 'disable_loop': {
                ...
                baseEmbed.setAuthor({ name: success ? errorMessage : await Translate(`**Repeat mode disabled **<a:3136simplemusicnote:1269705919684673536>\nthe queue will no longer be repeated <🔁>`) })
            ...
            case 'enable_loop_song': {
                ...
                baseEmbed.setAuthor({ name: success ? errorMessage : await Translate(`**Repeat mode enabled **<a:3136simplemusicnote:1269705919684673536>\nthe current song will be repeated endlessly (you can end the loop with <\`/loop disable\` >)`) })
            ...
            case 'enable_autoplay': {
                ...
                baseEmbed.setAuthor({ name: success ? errorMessage : await Translate(`**Autoplay enabled **<a:3136simplemusicnote:1269705919684673536>\nthe queue will be automatically filled with similar songs to the current one <🔁>`) })
